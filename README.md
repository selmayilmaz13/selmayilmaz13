...
Predictive modeling, recommender systems, and end-to-end ML pipelines on real-world data.

📍 Boston, MA • ✉️ yilmazelifselma13@gmail.com • 🔗 [linkedin.com/in/selma-yilmaz](https://linkedin.com/in/selma-yilmaz)
...
- **[Board Game Recommender](https://github.com/selmayilmaz13/boardgames-recommender)** — Hybrid recommender system (SVD + cosine similarity + MMR re-ranking) over 1.17M+ user interactions. Deployed as a live Streamlit app.

- **[DataCleanPro](https://github.com/selmayilmaz13)** — Python toolkit for data loading, preprocessing, transformation, and visualization with a clean modular API.
...
- M.S. Data Science — Northeastern University (GPA: 3.89/4.0)
- B.S. International Economics and Management — Università Bocconi
- Graduate Teaching Assistant — Intro to Programming for Data Science
